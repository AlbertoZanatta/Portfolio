var PageTransitions = function(a) {
    ...
    function b() {
        ...
        var m = location.hash.substr(1),
            ...
            o = a('#portfolio_grid figure a').each(function() {
                if (o = a(this).attr('href'), m == 'about_me/' + o.substr(0, o.length - 5)) {
        ...
        a('.subpages .ajax-page-load').click(function() {
            a(this).attr('href');
            return window.location.hash = 'about_me/' + a(this).attr('href').substr(0, a(this).attr('href').length - 5), !1
        })
    }
    ...
    function e(l) {
        if (!l.attr('data-animation')) return !1;
        if (!l.attr('data-goto')) return !1;
